...
$manual_tasks_sql = "
    SELECT
        ...
        MIN(t.status) AS task_status,
        MIN(t.assigned_to_user_id) AS assigned_to_user_id,
        MIN(t.assigned_to_group) AS assigned_to_group,
    ...
    ORDER BY FIELD(priority, 'Critica', 'Alta', 'Media', 'Baja'), created_at DESC
";
